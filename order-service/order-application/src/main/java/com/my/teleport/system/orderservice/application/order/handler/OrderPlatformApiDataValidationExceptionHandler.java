 ...
 * under the License.
 */
package com.my.teleport.system.orderservice.application.order.handler;
...
@Slf4j
@ControllerAdvice
public class OrderPlatformApiDataValidationExceptionHandler {


    @ExceptionHandler(value = {PlatformApiDataValidationException.class})
    public ResponseEntity<ApiGlobalErrorResponse> handleException(final PlatformApiDataValidationException exception) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(dataValidationErrorResponse);
    }
}