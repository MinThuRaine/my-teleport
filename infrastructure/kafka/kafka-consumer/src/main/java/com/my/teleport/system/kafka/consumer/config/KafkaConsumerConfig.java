package com.my.teleport.system.kafka.consumer.config;

import com.my.teleport.system.kafka.config.data.KafkaConfigData;
import com.my.teleport.system.kafka.config.data.KafkaConsumerConfigData;
